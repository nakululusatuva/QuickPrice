...
PROVIDER_CATALOG: Mapping[str, ProviderDescriptor] = {
    ...
    for item in (
        ...
        _descriptor(
            ...
            symbol_kind=VendorSymbolKind.CANONICAL,
            notes="Reads the current reserve liquidity rate from the fixed Aave V3 Ethereum deployment.",
        ),
        _descriptor(
        ...
        _descriptor(
            ...
            symbol_kind=VendorSymbolKind.NONE,
            binding_verification=BindingVerificationMode.NOT_APPLICABLE,
            notes="Quote and constant-ratio history derived from underlying prices and controlled protocol backing rules.",
        ),
        _descriptor(
            "synthetic",
